ddd@turbo[mini] qemu-mini> cat qemu.spec
%ifarch %{ix86}
%global kvm_arch   x86
...
%if %{user_mini}
%ifarch %{power64}
%global user_mini_arch  ppc64
%else
%global user_mini_arch  %{_arch}
%endif
%ifnarch x86_64
%global user_mini_fdt    --enable-fdt
%else
%global user_mini_fdt    --disable-fdt
%endif
%endif
...
# Mini configuration tweaks
Patch0003: 0003-Activate-missing-virtio-devices-for-mini-configurati.patch
Patch0004: 0004-Integrate-fix-c5b35f03c3f-to-get-CONFIG_VIRTIO_xyz-c.patch
...
%changelog
* Sat Oct 26 2019 Christophe de Dinechin <dinechin@redhat.com> - 2:4.1.0-5.mini11
- qemu-mini: Apparently, kata-runtime uses virtio-scsi

* Sat Oct 26 2019 Christophe de Dinechin <dinechin@redhat.com> - 2:4.1.0-5.mini10
- qemu-mini: Integrate qemu master fix for generation of CONFIG_ variables

* Fri Oct 25 2019 Christophe de Dinechin <dinechin@redhat.com> - 2:4.1.0-5.mini9
- qemu-mini: Adjust configuration patch for target

* Fri Oct 25 2019 Christophe de Dinechin <dinechin@redhat.com> - 2:4.1.0-4.mini8
- qemu-mini: Fix test for --enable-fdt

* Fri Oct 25 2019 Christophe de Dinechin <dinechin@redhat.com> - 2:4.1.0-4.mini7
- qemu-mini: Switch to config_target

* Thu Oct 24 2019 Christophe de Dinechin <dinechin@redhat.com> - 2:4.1.0-4.mini6
- qemu-mini: Use big hammer to enable virtio-serial and virtio-net

* Thu Oct 24 2019 Christophe de Dinechin <dinechin@redhat.com> - 2:4.1.0-4.mini5
- qemu-mini: Add fdt for both aarch64 and ppc

* Tue Oct 22 2019 Christophe de Dinechin <dinechin@redhat.com> - 2:4.1.0-4.mini4
- qemu-mini: Fix ppc64 build (name of target not related to Fedora arch)

* Wed Oct 16 2019 Christophe de Dinechin <dinechin@redhat.com> - 2:4.1.0-4.mini3
- qemu-mini: Add back vhost-net
...
* Wed Sep 4 2019 Christophe de Dinechin <dinechin@redhat.com> - 2:4.1.0-3.mini2
- Add dependency of qemu-mini on -core package

* Mon Sep 2 2019 Christophe de Dinechin <dinechin@redhat.com> - 2:4.1.0-1.mini1
